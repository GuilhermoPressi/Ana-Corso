...
export const planningLines: PlanningLine[] = [
  ...
  },
  {
    ...
    subtitle: "Indução percutânea de colágeno",
    description: "Avaliação de cicatrizes, poros, manchas e permeabilidade tecidual.",
    fields: [
      {
        id: "profundidade-agulha",
        label: "Profundidade pretendida (mm)",
        type: "choice",
        options: ["0.5 mm", "1.0 mm", "1.5 mm", "2.0 mm", "2.5 mm"],
        required: true,
      },
      {
        id: "indicacao-principal",
        label: "Indicação principal",
        type: "choice",
        options: ["Cicatriz de acne", "Rejuvenescimento", "Melasma / Manchas", "Poros dilatados", "Estrias"],
        required: true,
      },
      objetivoField(["Remodelamento tecidual", "Estímulo de colágeno", "Drug delivery", "Clareamento"]),
      observacoesField,
    ],
    regions: [
      { id: "face-total", name: "Face total", description: "Tratamento global de pele" },
      { id: "terco-medio", name: "Terço médio / Bochechas", description: "Poros e cicatrizes de acne" },
      { id: "pescoco-colo", name: "Pescoço e colo", description: "Textura e firmeza" },
    ],
  },
  {
    id: "peeling-quimico",
    name: "Peeling Químico",
    subtitle: "Renovação celular e despigmentação",
    description: "Mapeamento de hipercromias, textura e tolerância cutânea.",
    fields: [
      {
        id: "tipo-peeling",
        label: "Tipo de ácido / agente",
        type: "choice",
        options: ["Ácido Glicólico", "Ácido Salicílico", "Ácido Mandélico", "Ácido Retinóico", "TCA / ATA", "MelanOff / Blend"],
        required: true,
      },
      {
        id: "profundidade-peeling",
        label: "Profundidade do peeling",
        type: "choice",
        options: ["Muito superficial", "Superficial", "Médio"],
        required: true,
      },
      objetivoField(["Despigmentação", "Renovação celular", "Controle de oleosidade", "Aparência de poros"]),
      observacoesField,
    ],
    regions: [
      { id: "face-total", name: "Face total", description: "Despigmentação e renovação global" },
      { id: "regiao-malar", name: "Malar / Bochechas", description: "Manchas e melasma" },
      { id: "glabela-testa", name: "Testa", description: "Textura e rugas finas" },
    ],
  },
  {
    id: "fio-pdo",
    name: "Fio de PDO",
    subtitle: "Sustentação e estímulo de colágeno",
    description: "Vetores de tração, plano de inserção e sustentação de SMAS/subcutâneo.",
    fields: [
      {
        id: "tipo-fio",
        label: "Tipo de fio de PDO",
        type: "choice",
        options: ["Fio de Tração (Especulado)", "Fio Liso (Estímulo)", "Fio Preenchedor / Filler", "Fio de Garra / Matrix"],
        required: true,
      },
      {
        id: "vetor-tracao",
        label: "Vetor de tração",
        type: "choice",
        options: ["Vetor Zigo-Malar", "Vetor Mandibular / Jowl", "Vetor Cervical", "Vetor Sobrancelha (Fox eyes)"],
        required: true,
      },
      objetivoField(["Lifting de tecido", "Estímulo de colágeno local", "Suporte de sulco", "Definição de contorno"]),
      observacoesField,
    ],
    regions: [
      { id: "terco-medio", name: "Terço médio / Bochecha", description: "Tração de malar e sulco" },
      { id: "terco-inferior", name: "Terço inferior / Jowl", description: "Definição de linha da mandíbula" },
      { id: "pescoco", name: "Pescoço / Papada", description: "Ancoragem cervical" },
      { id: "sobrancelha", name: "Cauda da sobrancelha", description: "Elevação do olhar" },
    ],
  },
  {
    id: "co2-fracionado",
    name: "CO2 Fracionado",
    subtitle: "Rejuvenescimento e remodelamento",
    description: "Fotodano, profundidade de ação e tempo de recuperação.",
    fields: [
      {
        id: "nivel-energia",
        label: "Intensidade do disparo",
        type: "choice",
        options: ["Leve (Downtime 2-3 dias)", "Moderado (Downtime 4-5 dias)", "Intenso (Downtime 7+ dias)"],
        required: true,
      },
      objetivoField(["Remodelamento profundo", "Tratamento de cicatrizes", "Rejuvenescimento periorbital", "Flacidez pálpebras"]),
      observacoesField,
    ],
    regions: [
      { id: "face-total", name: "Face total", description: "Rejuvenescimento completo" },
      { id: "periorbital", name: "Pálpebras / Periorbital", description: "Rugas de expressão e flacidez palpebral" },
      { id: "perioral", name: "Perioral / Código de barras", description: "Rugas periorais" },
    ],
  },
  {
    id: "ultrassom-microfocado",
    name: "Ultrassom Microfocado",
    subtitle: "Lifting não cirúrgico e ancoragem de SMAS",
    description: "Profundidade dos disparos, espessura da fáscia e vetores de ancoragem.",
    fields: [
      {
        id: "cartuchos-utilizados",
        label: "Cartuchos / Profundidades",
        type: "multi",
        options: ["1.5 mm (Derme)", "3.0 mm (Subcutâneo)", "4.5 mm (SMAS)", "2.0 mm (Periorbital)"],
        required: true,
      },
      {
        id: "estimativa-linhas",
        label: "Estimativa de disparos / linhas",
        type: "choice",
        options: ["200 disparos", "300 disparos", "400 disparos", "500+ disparos"],
        required: true,
      },
      objetivoField(["Lifting de SMAS", "Efeito compactador de gordura", "Ancoragem de contorno", "Tratamento de papada"]),
      observacoesField,
    ],
    regions: [
      { id: "terco-inferior", name: "Terço inferior e Jowl", description: "Compactação e lifting de contorno" },
      { id: "papada", name: "Submento / Papada", description: "Redução de gordura e firmeza" },
      { id: "terco-medio", name: "Terço médio / Maçã do rosto", description: "Ancoragem zigomática" },
      { id: "pescoco", name: "Pescoço", description: "Tratamento de flacidez cervical" },
    ],
  },
  {
    id: "intradermoterapia",
    name: "Intradermoterapia",
    subtitle: "Mesoterapia e drug delivery",
    description: "Ativos indicados, profundidade de pápula e plano de aplicação.",
    fields: [
      {
        id: "mescla-ativos",
        label: "Ativos principais da mescla",
        type: "multi",
        options: ["Ácido Hialurônico não reticulado", "Vitamina C", "Silício Orgânico", "DMAE", "Polinucleotídeos / PDRN", "Peptídeos botulínicos"],
        required: true,
      },
      objetivoField(["Hidratação profunda (Skinbooster)", "Estímulo de firmeza", "Ação antioxidante", "Regeneração celular"]),
      observacoesField,
    ],
    regions: [
      { id: "face-total", name: "Face total", description: "Pápulas de hidratação e firmeza" },
      { id: "pescoco-colo", name: "Pescoço e colo", description: "Nutrição e hidratação tecidual" },
      { id: "maos", name: "Dorso das mãos", description: "Rejuvenescimento de mãos" },
    ],
  },
]
